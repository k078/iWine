...
import { Winebottle, WineType } from "src/app/components/bottle/Winebottle";
import { Wineries} from "src/app/components/winery/Winery";
...
export class BottleService {
    winebottles = [
        new Winebottle(1, WineType.SauvignonBlanc, "Sten's Sauv", 2018, "Chili", 5.99, false, Wineries[1], "/assets/sauv.png"),
